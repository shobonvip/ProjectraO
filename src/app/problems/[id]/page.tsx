        ...
        {problem && (
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 space-y-6">
            <div className="flex justify-between items-start border-b border-slate-100 pb-4">
              <div>
                {!(problem.points===0 || problem.label==="") && 
                    <span
                    className="text-sm font-semibold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full"
                    >
                    問題 {problem.label} ({problem.points} 点)
                    </span>
                }
                <span
...
{problem.answer && (
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={status === "SUBMITTING" || !userAnswer.trim()}
